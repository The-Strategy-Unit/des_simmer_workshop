...
---
# Introduction
This workshop builds a discrete event simulation model using a primary care example. The model worksheet can be found here: [LINK]
...
```{r part 1B Q3a}
part1B_callwait_results<-env_part1B%>%get_mon_attributes() %>%
