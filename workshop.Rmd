...
```{r part 1: run the model, echo=TRUE, results='hide'}
set.seed(1)
env_part1 %>%
  run()
```
...
```{r part 1B run, echo=TRUE, results='hide'}
set.seed(1)
env_part1B %>% run()
```
...
```{r part 2: run model, echo=TRUE, results='hide'}
set.seed(1)
env_part2 %>%
  run(t_day(5))
```
...
```{r part 2: option B run, warning=FALSE, echo=TRUE, results='hide'}
set.seed(1)
env_part2B %>%
  run(t_day(5))
```
...
```{r part 3: replicate model runs, echo=TRUE, results='hide'}
...
```{r part 4: replicate model runs, echo=TRUE, results='hide'}
...
```{r part 3: option B set up, echo=TRUE, results='hide'}
...
```{r part 3: option B set up scenario, echo=TRUE, results='hide'}
